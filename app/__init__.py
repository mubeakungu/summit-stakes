...
def create_app():
    ...
    database_url = os.environ.get("DATABASE_URL", "postgresql://localhost/summit_stakes")
    # Render (and some other hosts) hand out postgres:// URLs, and SQLAlchemy
    # needs the psycopg3 dialect spelled out explicitly via postgresql+psycopg://
